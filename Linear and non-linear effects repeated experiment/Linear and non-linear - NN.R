##############################################################
## Experiment with linear and non-linear effects - Neural network
##############################################################
...
nodes_layer1_occ   = 5
nodes_layer2_occ   = 5
learning_rate_occ  = 0.005
early_stopping_occ = 15
epochs_occ         = 50
batch_size_occ     = 64
nodes_layer1_rep   = 15
nodes_layer2_rep   = 10
learning_rate_rep  = 0.0001
early_stopping_rep = 5
epochs_rep         = 50
batch_size_rep     = 32
...
for (l in 1:L) {
  ...
  # save_model_hdf5(model_occ, filepath = paste0("NN_occ_exp2_",l))  
  # save_model_hdf5(model_rep, filepath = paste0("NN_rep_exp2_",l))  
